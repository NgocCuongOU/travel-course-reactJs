                                ...
                                <form className="form" onSubmit={handleRegister}>
                                    ...
                                    <div className="wrap-submit">
                                        <div className="form-extends">
                                            <p>Bạn đã có tài khoản? <Link to="/login">Đăng nhập</Link> tại đây!</p>
                                        </div>
                                        <button type="submit" className="btn btn-lg">Đăng ký</button>
                                    </div>
                                </form>
                            </div>
                        </div>
...
function FormRegisterRight(props) {
    return (
        <div className="form-group">
            <label htmlFor={props.id} className="form-label col-form-label-lg ">{props.title}<span className="book-required">*</span></label>
            <input type={props.type} value={props.value} onChange={props.change} className="form-control form-control-lg" id={props.id} placeholder={props.placeholder} />
        </div>
    )
} 
